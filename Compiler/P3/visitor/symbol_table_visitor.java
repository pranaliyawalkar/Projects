...
public class symbol_table_visitor<R> implements GJNoArguVisitor<R> {
	...
	int ir_temp=20;
	int ir_temp_param=1;
	int ir_temp_vars=4; //offset begins from 4
	int ir_temp_methods = 0;
...
//
   ...
   public LinkedHashMap<String,Class_info> return_symbol_table()
   {
	   return symbol_tab;
   ...
   public R visit(ClassDeclaration n) {
      ...
      if(flag==0)
      {
    	  ...
    	  {System.out.println("Type error1");
		  System.exit(0);
		  }
    	  Class_info new_class_1 = new Class_info();
      	  symbol_tab.put(class_name,new_class_1);
...
//ME -WHENEVER I SEE A NEW CLASS I SHOULD EMPTY ALL MY LinkedHashMapS.
   ...
   public R visit(ClassExtendsDeclaration n) {
      ...
      if(flag==0)
      {
          ...
          list_temp1 = dependent_class.get(class_name); 
      	  //System.out.println("class : " + class_name ); 
    	  if(symbol_tab.get(class_name)!=null)
    	  {System.out.println("Type error2");
		  System.exit(0);
      ...
      if(flag==0)
      {
	      if(meth_name.equals(""))
	      {
	    	  ...
	    	  vars = new LinkedHashMap<String, String>();
	      	  ...
	      	  {System.out.println("Type error3");
			  System.exit(0);
			  }
	      	  vars.put(id,ir_temp_vars+" "+type);
	      	  ir_temp_vars = ir_temp_vars+4;
	      	  Class_info_temp.vars.putAll(vars);
	      	  Class_info_temp.methods.putAll(methods);
	      	  symbol_tab.put(class_name,Class_info_temp);
	      ...
	      else
	      {
	      	...
	      	locals = new LinkedHashMap<String, String>();
	      	 ...
	      	 // if(locals.get(n.f1.f0.toString())!=null)
	      	  ...
	      	  locals.put(n.f1.f0.toString(),ir_temp++ + " " +type);
   ...
   public R visit(MethodDeclaration n) {
      ...
      if(flag==0)
      {
    	  ...
    	  {System.out.println("Type error4");
		  System.exit(0);
		  }
    	  //over riding - 
		  ...
		  methods.putAll( Class_info_temp.methods);
		  method Method1= new method();
		  Method1.return_type=ir_temp_methods+" "+return_type;
		  ir_temp_methods=ir_temp_methods+4;
    		  ...
    		  */while(params_count <= params.size())
    		  {
    			  ...
    			  {
    				  {System.out.println("Type error5");
    	    		  System.exit(0);
    	    		  }
    				  break;
    			  }
    		  ...
    		  {System.out.println("Type error6");
    		  System.exit(0);
    		  }
      ...
      if(flag==0)
      {
    	...
    	//  System.out.println("my id is "+id);
    	 ...
    	 // System.out.println("in formal param  "+meth_name+type);
	      ...
	      {System.out.println("Type error7");
		  System.exit(0);
		  }
	      type=ir_temp_param++ + " " +type;
	      params.put(id, type);
...
/*	    	if(symbol_tab.get("Yawalkar")!=null)
    	 ...
    	 // System.out.println("parent : " + parent_type);
    	  if(!type2.equals(type1) && !parents.get(type2).equals(type1))
    	  {
    		 // System.out.println("type1 : " +type1 + "  type2 : " + type2);
    		  ...
    		  {System.out.println("Type error8");
    		  System.exit(0);
    		  }
    	  }
   ...
   public R visit(ArrayAssignmentStatement n) {
      ...
      if(flag==1)
      {
    	  ...
    	  if(!type1.equals("int[]"))
    	  {
    		  {System.out.println("Type error9");
    		  System.exit(0);
    		  }
    	  }
      ...
      if(flag==1)
      {
    	  ...
    	  if(!type2.equals("int"))
    	  {
    		  {System.out.println("Type error10");
    		  System.exit(0);
    		  }
    	  }
      ...
      if(flag==1)
      {
    	  ...
    	  if(!type3.equals("int"))
    	  {
    		  {System.out.println("Type error11");
    		  System.exit(0);
    		  }
    	  }
      ...
      if(flag==1)
      {
    	  ...
    	  if(!type1.equals("boolean"))
    	  {
    		 ...
    		 // System.out.println("type is : " +type1);
    		  {System.out.println("Type error12");
    		  System.exit(0);
    		  }
    	  }
      }
   ...
   public R visit(WhileStatement n) {
      ...
      if(flag==1)
      {
    	  ...
    	  if(!type1.equals("boolean"))
    	  {System.out.println("Type error13");
		  System.exit(0);
		  }
      }
      n.f3.accept(this);
      ...
      else if(flag==1)
      {
    	 ...
    	 // if(identifier_type.equals(""))
    	  ...
    	  if(!id.equals("int"))
    	  {
    		  ...
    		  {System.out.println("Type error14");
    		  System.exit(0);
    		  }
    	  }
      }
   ...
   public R visit(AndExpression n) {
      ...
      else
      {
    	  ...
    	  {
    		  {System.out.println("Type error15");
    		  System.exit(0);
    		  }
    	  }
    	  n.f1.accept(this);
    	  ...
    	  if(!type.equals("boolean"))
    	  {
    		  {System.out.println("Type error16");
    		  System.exit(0);
    		  }
    	  }
    	  return (R)"boolean";
   ...
   public R visit(CompareExpression n) {
      ...
      else
      {
    	  ...
    	  if(!type.equals("int"))
    	  {
    		  ...
    		  {System.out.println("Type error17");
    		  System.exit(0);
    		  }
    	  }
    	  n.f1.accept(this);
    	  ...
    	  if(!type.equals("int"))
    	  {
    		 // System.out.println(expression_type+"  in compareexpr");
    		  {System.out.println("Type error18");
    		  System.exit(0);
    		  }
    	  }
   ...
   public R visit(PlusExpression n) {
      ...
      else
      {
    	  ...
    	  if(!type.equals("int"))
    	  {
    		  {System.out.println("Type error19");
    		  System.exit(0);
    		  }
    	  }
    	  identifier_type="";
    	  ...
    	  {
    		//  System.out.println(expression_type+"  in compareexpr");
    		  {System.out.println("Type error20");
    		  System.exit(0);
    		  }
    	  }
    	  return (R)"int";
   ...
   public R visit(TimesExpression n) {
      ...
      else
      {
    	  ...
    	  {
    		 // System.out.println(expression_type+"  in compareexpr");
    		  {System.out.println("Type error24");
    		  System.exit(0);
    		  }
    	  }
    	  return (R)"int";
   ...
   public R visit(ArrayLookup n) {
      ...
      else
      {
    	  ...
    	  if(!type.equals("int[]"))
    	  {
    		  {System.out.println("Type error25");
    		  System.exit(0);
    		  }
    	  } 
    	  n.f1.accept(this);
    	 ...
    	 // System.out.println("new_object called : "+new_object_called +" new_method_called : "+new_method_called);
    	 ...
    	 else if(symbol_tab.get(class_name).methods.get(meth_name).locals.get(new_object_called) !=null)
    	  {
     		...
     		params = new LinkedHashMap<String, String>();
     		 ...
     		 if(params.size()!=stack2.size())
			 {System.out.println("Type error30");
	    		  System.exit(0);
	    		  } 
     		 while(!stack2.empty())
     		 {
	   			...
	   			for(String param : params.values())
	   			{
	   				...
	   				else if (i==param_count && (!popping.equals(param)))
	                   {
	   				  ...
	   				  {System.out.println("Type error31");
	   	    		  System.exit(0);
	   	    		  }
	                    	break;
	                   }
    	  ...
    	  else if(symbol_tab.get(class_name).methods.get(meth_name).params.get(new_object_called) !=null)
    	  {
      		...
      		params = new LinkedHashMap<String, String>();
      		 ...
      		 if(params.size()!=stack2.size())
			 {System.out.println("Type error32");
	    		  System.exit(0);
	    		  } 
      		 while(!stack2.empty())
      		{
   			...
   			for(String param : params.values())
   			{
   				...
   				else if (i==param_count && (!popping.equals(param)))
                   {
   					...
   					//System.out.println(popping+param);
   				  {System.out.println("Type error33");
   	    		  System.exit(0);
   	    		  }
                    	break;
                   }
    	  ...
    	  else if (in_this==1) //this wala method called;
    	  {
    		  ...
    		  params.putAll(symbol_tab.get(class_name).methods.get(new_method_called).params);
        		...
        		//	 System.out.println(params);
    			 ...
    			 if(params.size()!=stack2.size())
    			 {System.out.println("Type error34");
 	    		  System.exit(0);
 	    		  } 
    		  while(!stack2.empty())
     		 {
     			...
     			for(String param : params.values())
     			{
     				...
     				else if (i==param_count && (!popping.equals(param)))
                     {
     					...
     					//System.out.println(popping+param);
     					  {System.out.println("Type error35");
     		    		  System.exit(0);
     		    		  }
                      	break;
                     }
    	  ...
    	  else if(in_new==1)
    	  {
    		 ...
    		 // System.out.println(params);
    		  ...
    		  //System.out.println(params);
    			 ...
    			 if(params.size()!=stack2.size())
    			 {System.out.println("Type error36");
 	    		  System.exit(0);
 	    		  } 
    		  while(!stack2.empty())
     		 {
     			...
     			for(String param : params.values())
     			{
     				...
     				else if (i==param_count && (!popping.equals(param)))
                     {
     					...
     					//System.out.println(popping+param);
     					  {System.out.println("Type error37");
     		    		  System.exit(0);
     		    		  }
                      	break;
                     }
    	  ...
    	  else if(symbol_tab.get(new_object_called).methods.get(new_method_called)!=null)
    	  {
    		  ...
    		  params .putAll(symbol_tab.get(new_object_called).methods.get(new_method_called).params);
    			 ...
    			 if(params.size()!=stack2.size())
    			 {System.out.println("Type error38");
 	    		  System.exit(0);
 	    		  } 
    		  while(!stack2.empty())
     		 {
     			...
     			for(String param : params.values())
     			{
     				...
     				else if (i==param_count && (!popping.equals(param)))
                     {
     					...
     					//System.out.println(popping+param);
     					  {System.out.println("Type error39");
     		    		  System.exit(0);
     		    		  }
                      	break;
                     }
    	  ...
    	  else if(symbol_tab.get(new_caller_type).methods.get(new_method_called)!=null)
    	  {
    		  ...
    		  params .putAll( symbol_tab.get(new_caller_type).methods.get(new_method_called).params);
    			 ...
    			 if(params.size()!=stack2.size())
    			 {System.out.println("Type error40");
 	    		  System.exit(0);
 	    		  } 
    		  while(!stack2.empty())
      		 {
      			...
      			for(String param : params.values())
      			{
      				...
      				else if (i==param_count && (!popping.equals(param)))
                      {
      					...
      					//System.out.println(popping+param);
      				  {System.out.println("Type error41");
      	    		  System.exit(0);
      	    		  }
                       	break;
                      }
...
//		   	/	  System.out.println("kill me" + symbol_tab.get("Pranali").methods.get("Comp").params.get("l"));
   ...
   public R visit(ArrayAllocationExpression n) {
      ...
      if(flag==1)
      {
    		  ...
    		  {
    		      n.f4.accept(this);
    		      {System.out.println("Type error42");
        		  System.exit(0);
        		  }
    			  return null;
    		  }
   ...
   public R visit(AllocationExpression n) {  
	      ...
	      else 
	      {
	    	...
	    	//  System.out.println("in allocation expression");
	    	  ...
	    	  {
	    		  {System.out.println("Type error43");
	    		  System.exit(0);
	    		  }
	    		  return null;
	    	  }
   ...
   public R visit(NotExpression n) {
      ...
      if(flag==1)
      {
    	  ...
    	  if(!type.equals("boolean"))
    	  {System.out.println("Type error44");
		  System.exit(0);
		  }
    	  return (R)"boolean";
