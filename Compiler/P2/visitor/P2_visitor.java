...
public class P2_visitor<R> implements GJNoArguVisitor<R> {
   ...
   public R visit(MainClass n) {
      ...
      if(flag==0)
      {
    	 ...
    	 // System.out.print("class : " +class_name);
    	  //System.out.print("method : " +"void  "+meth_name);
      }
      n.f7.accept(this);
      n.f8.accept(this);
      n.f9.accept(this);
      ...
      { 
    	...
    	// System.out.print("params : " +"String[]  "+ id);
      }
      n.f12.accept(this);
      n.f13.accept(this);
      n.f14.accept(this);
...
//ME -WHENEVER I SEE A NEW CLASS I SHOULD EMPTY ALL MY LinkedHashMapS.
   ...
   public R visit(ClassExtendsDeclaration n) {
      ...
      if(flag==0)
      {
	      ...
	      //System.out.print("extended class : " +class_name_of_extended_class);
	      if(symbol_tab.get(class_name_of_extended_class)!=null)
	      {
		   ...
		   /*   if(symbol_tab.get("Yawalkar")!=null)
		    	...
		    	System.out.print(	symbol_tab.get("Yawalkar").methods.get("Comp").params.size());*/
	      }
	      else
	      {
	      ...
	      else
	      {
	      	...
	      	locals = new LinkedHashMap<String, String>();
	      	 ...
	      	 // if(locals.get(n.f1.f0.toString())!=null)
	      		//  System.out.print("error26");
	      	  locals.put(n.f1.f0.toString(),type);
	      	  methods.get(meth_name) .locals = locals;
	      	  Class_info_temp.methods.putAll(methods);
	      	  symbol_tab.put(class_name,Class_info_temp);
	      	//System.out.print("locals : " + type + " " + n.f1.f0.toString());
	      } 
      }
      n.f2.accept(this);
      return _ret;
   ...
   public R visit(MethodDeclaration n) {
      ...
      //System.out.print(meth_name+class_name);
      if(flag==0)
      {
		  ...
		  //System.out.print("checking here");
		 /* if(symbol_tab.get("Yawalkar")!=null)
	    		if(symbol_tab.get("Yawalkar").methods!=null)
		  ...
		  */
	  	...
	  	// System.out.print("checking here1");
		/*  if(symbol_tab.get("Yawalkar")!=null)
	    		if(symbol_tab.get("Yawalkar").methods!=null)
	    			if(symbol_tab.get("Yawalkar").methods.get("Comp")!=null)
	    				if(symbol_tab.get("Yawalkar").methods.get("Comp").params!=null)
	  	...
	  	//System.out.print("method : " + return_type + " " + meth_name);
      ...
      if(flag3==1)
      {
    	  ...
    	  {
    		  //System.out.print("could be return type and return type 1 are :  " +return_type+" " + return_type1);
    		  //System.out.print("size is " +params.size()+" "+params1.size());
    		 /* if(symbol_tab.get("Yawalkar").methods.get("Comp").params!=null)
    			  if(symbol_tab.get("Yawalkar")!=null)
    		    		if(symbol_tab.get("Yawalkar").methods!=null)
    		    			if(symbol_tab.get("Yawalkar").methods.get("Comp").params!=null)
     ...
     else
      {
    	  ...
    	  identifier_type="";
    	  String id= (String)n.f10.accept(this);
    	  ...
    	  if(!type2.equals(symbol_tab.get(class_name).methods.get(meth_name).return_type))
    	  {
    		  System.out.print("Type error");
    		  System.exit(0);
    	  }
     ...
     // n.f1.accept(this);
      ...
      if(flag==0)
      {
    	...
    	//  System.out.print("my id is "+id);
    	  Class_info_temp=symbol_tab.get(class_name);
    	 // System.out.print("in formal param  "+meth_name+type);
    	  methods = new LinkedHashMap<String, method>();
	      methods .putAll( Class_info_temp.methods);
	      params = new LinkedHashMap<String, String>();
	      params.putAll(methods.get(meth_name).params);
	      ...
	      params.put(id, type);
	   	  ...
	   	  symbol_tab.put(class_name,Class_info_temp);
	   	 // System.out.print("params : " + type + " " + id);
/*	    	if(symbol_tab.get("Yawalkar")!=null)
	    		if(symbol_tab.get("Yawalkar").methods!=null)
	    			if(symbol_tab.get("Yawalkar").methods.get("Comp").params!=null)
	    	System.out.print(	symbol_tab.get("Yawalkar").methods.get("Comp").params.size());*/
		  		//System.out.print("love1");
	   	  //if(symbol_tab.get("Fac").methods.get("ComputeFac").params.get("num")!=null)
	   		  //System.out.print("kill me" + symbol_tab.get("Fac").methods.get("ComputeFac").params.get("num"));
      }
   	  return _ret;
   }
   /**
   ...
   public R visit(AssignmentStatement n) {
      ...
      else
      {
    	...
    	//  System.out.print("fuckmetoo" + identifier_type);
    	  if(identifier_type.equals(""))
    		  type1=id;  
    	  else
    	  {
      ...
      else
      {
    	 ...
    	 // System.out.print("parent : " + parent_type);
    	  if(!type2.equals(type1) )
    	  {
    		  if((parent_type!=null && !(parent_type.equals(type1)))|| parent_type==null)
    		 // System.out.print("type1 : " +type1 + "  type2 : " + type2);
    		  //System.out.print("current class : " + class_name + " current method : "+ meth_name);
    		  {System.out.print("Type error");
    		  System.exit(0);
    		  }
    	  }
   ...
   public R visit(IfStatement n) {
      ...
      if(flag==1)
      {
    	  ...
    	  {
    		 // System.out.print(" current class : "+class_name+" currect method : "+meth_name);
    		 // System.out.print("type is : " +type1);
    		  {System.out.print("Type error");
    		  System.exit(0);
    		  }
    	  }
   ...
   public R visit(PrintStatement n) {
      ...
      {
    	  //System.out.print("in print " +expression_type);    	 
    	  identifier_type="";
    	  String id= (String)n.f2.accept(this);
    	 if(identifier_type.equals(""))
    		 type1=id;  
   ...
   public R visit(CompareExpression n) {
      ...
      else
      {
    	  ...
    	  if(!type.equals("int"))
    	  {
    		 // System.out.print(expression_type+"  in compareexpr");
    		  {System.out.print("Type error");
    		  System.exit(0);
    		  }
    	  }
    	//  System.out.print("in comparison");
    	  return (R)"boolean";
   ...
   public R visit(MessageSend n) {
     ...
     // if(stack.empty())
      ...
      else
      {
    	 ...
    	 // System.out.print("substring"+(popping.substring(0, 6)));
    	  while(true)
    	  {
    		  popping = stack.pop();
    		  if(popping.length()>=6)
    		  {
    			  if(!((popping.substring(0, 6)).equals("class ")))
    			  {
    				  ...
    				  //System.out.print("popping1 and putting in stack2 : "+popping);
    				  stack2.push(popping);
    			  }
    			  else break;
    		  }
    		else
    		{
    			//System.out.print("in while");
				  //System.out.print("popping and putting in stack2 : "+popping);
				  stack2.push(popping);
    		}
    	  }
    	 // if(!stack.empty())
    		//  System.out.print("fuckyou");
    	//  System.out.print("final popping : "+popping);
    	...
    	/*  while(!stack2.empty())
    	 ...
    	 // System.out.print("new_object called : "+new_object_called +" new_method_called : "+new_method_called);
    	  //System.out.print("new_fuckcaller_type : "+new_caller_type +" new_method_called : "+new_method_called);
    		...
    		//	 System.out.print(params);
    		 ...
    		 while(!stack2.empty())
    		 {
    			...
    			for(String param : params.values())
    			{
    				...
    				{
    				//	System.out.print("message sent1");	 
    					break;
    				}
    				else if (i==param_count && (!popping.equals(param)))
                    {
                 
    					//System.out.print(popping+param);
    					  {System.out.print("Type error");
    		    		  System.exit(0);
    		    		  }
                     	break;
    	 ...
    	 else if(symbol_tab.get(class_name).methods.get(meth_name).locals.get(new_object_called) !=null)
    	  {
			 ...
			 {System.out.print("Type error");
     		 ...
     		 while(!stack2.empty())
     		 {
	   			...
	   			popping = stack2.pop();
	   			//System.out.print("stack 2 : "+popping);
	   			param_count++;
	   			i=1;
	   			for(String param : params.values())
	   			{
	   				if((popping.equals(param) || param.equals(parents.get(popping))) && param_count==i)
	   				{
	   					//System.out.print("message sent2");	 
	   					break;
	   				}
	   				else if (i==param_count && (!popping.equals(param)))
	                   {
	   					...
	   					//System.out.print(popping+param);
	   					//System.out.print("i: " +i +" param_count : "+param_count + " ");
	   				  {System.out.print("Type error");
	   	    		  System.exit(0);
	   	    		  }
	                    	break;
    		 ...
    		 // System.out.print("actual type : "+actual_type);
    		 // System.out.print(symbol_tab.get(actual_type).methods.get(new_method_called).return_type);
    		  return (R)(symbol_tab.get(actual_type).methods.get(new_method_called).return_type);
    	  }
			 ...
			 {System.out.print("Type error");
      		 ...
      		 while(!stack2.empty())
      		{
   			...
   			for(String param : params.values())
   			{
   				if((popping.equals(param) || param.equals(parents.get(popping))) && param_count==i)
   				{
   					//System.out.print("message sent31");	 
   					break;
   				}
   				else if (i==param_count && (!popping.equals(param)))
                   {
     		  ...
     		  //System.out.print("actual type : "+actual_type);
     		 // System.out.print(symbol_tab.get(actual_type).methods.get(method_called).return_type);
    	  ...
    	  else if (in_this==1) //this wala method called;
    	  {
    		  ...
    		  while(!stack2.empty())
     		 {
     			...
     			for(String param : params.values())
     			{
     				if((popping.equals(param) || param.equals(parents.get(popping))) && param_count==i)
     				{
     					//System.out.print("message sent4");	 
     					break;
     				}
     				else if (i==param_count && (!popping.equals(param)))
                     {
    	  ...
    	  else if(in_new==1)
    	  {
    		  ...
    		  in_new=0;
    		  //System.out.print("identifier_type :"+ identifier_type);
    		  int param_count=0;
    		  int i=0;
    		  params = new LinkedHashMap<String, String>();
    		 // System.out.print(params);
    		  ...
    		  while(!stack2.empty())
     		 {
     			...
     			for(String param : params.values())
     			{
     				if((popping.equals(param) || param.equals(parents.get(popping))) && param_count==i)
     				{
     					//System.out.print("message sent5");	 
     					break;
     				}
     				else if (i==param_count && (!popping.equals(param)))
                     {
    	  ...
    	  else if(symbol_tab.get(new_object_called).methods.get(new_method_called)!=null)
    	  {
    		  ...
    		  while(!stack2.empty())
     		 {
     			...
     			for(String param : params.values())
     			{
     				if((popping.equals(param) || param.equals(parents.get(popping))) && param_count==i)
     				{
     					//System.out.print("message sent6");	 
     					break;
     				}
     				else if (i==param_count && (!popping.equals(param)))
                     {
    		  ...
    		  while(!stack2.empty())
      		 {
      			...
      			for(String param : params.values())
      			{
      				if((popping.equals(param) || param.equals(parents.get(popping))) && param_count==i)
      				{
      					//System.out.print("message sent7");	 
      					break;
      				}
      				else if (i==param_count && (!popping.equals(param)))
                      {
    	  ...
    	  {
    		//  System.out.print("object called : "+new_object_called +" method_called : "+new_method_called);
    		  //System.out.print("check10");
    		
    		  return null;
    	  }
      }
    	 //System.out.print("object : " +object_called+" method_called : "+method_called);
    	 //System.out.print("pappa "+symbol_tab.get(object_called).methods.get(method_called).return_type);
   ...
   public R visit(ExpressionList n) {
      ...
      {	      	  
    	  ...
    	  //System.out.print("caller : " +caller_type + "  method_called  "+ method_called + " type : "+ type);
          if(type.equals("int") || type.equals("int[]") || type.equals("boolean") || symbol_tab.get(type)!=null)
          {  
        	  stack.push(type);
        	  //System.out.print("Type pushing : "+ type);
          }
   ...
   public R visit(ExpressionRest n) {
      ...
      {	  identifier_type="";
    	  ...
    	  //System.out.print("in expression rest +" +type);
            if(type.equals("int") || type.equals("int[]") || type.equals("boolean") || symbol_tab.get(type)!=null)
            {
            	//System.out.print("Type pushing : " +type);
            	stack.push(type);
...
//		   	/	  System.out.print("kill me" + symbol_tab.get("Pranali").methods.get("Comp").params.get("l"));
		   ...
		   else
		   {
			...
			//   System.out.print("class : " +class_name +"meth_name : "+meth_name);
			   
			   //System.out.print("check3 "+n.f0.toString());
			   if(params.get(n.f0.toString())!=null)
			   {
				   //System.out.print("check "+n.f0.toString());
				   identifier_type = params.get(n.f0.toString());
			   }
			   else if(locals.get(n.f0.toString())!=null)
			   {
				  // System.out.print("check2 "+n.f0.toString());
				   identifier_type =locals.get(n.f0.toString());  
			   }
			   else if(vars.get(n.f0.toString())!=null)
			   {
				   //System.out.print("checkcheck "+n.f0.toString());
				   identifier_type =vars.get(n.f0.toString());
			   }
			   /*
		...
		//  System.out.print("fuckme" + identifier_type);
		  return (R)n.f0.toString();
	   }
   }
   ...
   public R visit(AllocationExpression n) {  
	      ...
	      else 
	      {
	    	...
	    	//  System.out.print("in allocation expression");
	    	  String id =(String) n.f1.accept(this);
   ...
   public R visit(BracketExpression n) {
      ...
      else
      {
    	 ...
    	 //System.out.print("in bracketed "+s);
    	 n.f2.accept(this);
    	 in_bracketed=0;
    	  return (R)s;
      }
